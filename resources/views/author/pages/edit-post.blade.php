...
@section('contents')
    ...
    <form action="{{route('author#updatePost',$post->post_id)}}" method="post" id="editPost" enctype="multipart/form-data">
        @csrf
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-9">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" rows="8" name="postContent" placeholder="Content..." id="postContent">{{ old('postContent', $post->content) }}</textarea>
                            @error('postContent')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="mb-3">
                            <img src="" class="img-thumbnail" style="width: 250px;" id="image-previewer"
                                data-ijabo-default-img="{{ asset($post->post_image !== null ? 'storage/postImage/' . $post->post_image : 'defaultImage/default-image.jpg') }}">
                        </div>
